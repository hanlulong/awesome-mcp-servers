...
- <img src="https://data.openecon.ai/favicon.ico" height="14"/> [OpenEcon Data](https://github.com/hanlulong/openecon-data) - Query economic data from 10+ sources (FRED, World Bank, IMF, Eurostat, BIS, UN Comtrade, Statistics Canada, OECD, CoinGecko) using natural language with 330K+ indicators and smart discovery
